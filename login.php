...
>>>>>>> f1fac1486a2b815d092c73ffc44e188b299864c1
  ...
  <body style="background-color: #FAF9F9">
    ...
    <div class="container h-100" style="color">
      <div class="d-flex justify-content-center h-100">
        <div class="user_card" style="background: #7FFFD4;">
          ...
          <div class="d-flex justify-content-center form_container">
             ...
             <button type="sumbit" name="reg_user" class="btn login_btn">Login</button>
             </div>
            </form>
          </div>
          ...
          <div class="mt-4">
            <div class="d-flex justify-content-center links">
              Not registered ? <a href="login.php" class="ml-2">Register Now</a>
            </div>
            <div class="d-flex justify-content-center links">
